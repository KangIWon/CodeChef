...
public class UserFrameworkController {
    ...
    public ApiResponse createUserFramework(@AuthenticationPrincipal AuthUser authUser, List<FrameworkRequest> frameworkRequestList)
    {
    ...
    {
        return ApiResponse.createSuccess(HttpStatus.OK.value(), "유저 프레임워크 수정에 성공했습니다.", userFrameworkService.updateUserFramework(authUser));
    }
