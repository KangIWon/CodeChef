...
public class RedisChatService {
     ...
     * @return
     */
    public Page<MessageGetResponse> findAllMessages(int page, int size, Long roomId) {
        Pageable pageable = PageRequest.of(page * -1, size, Sort.by(Sort.Direction.ASC, "id"));

        return this.chatRepository.findAllMessageByRoomId(roomId, pageable)
                .map(MessageGetResponse::new);
    }
     ...
     * @return
     */
    public Page<ChatUserGetResponse> findAllUsers(int page, int size, Long roomId) {
        Pageable pageable = PageRequest.of(page * -1, size, Sort.by(Sort.Direction.ASC, "id"));

        return this.chatRepository.findAllChatUserByRoomId(roomId, pageable);
    }
