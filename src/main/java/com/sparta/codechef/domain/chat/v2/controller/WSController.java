...
public class WSController {
     ...
     * @return 채팅 메세지 리스트
     */
    @SubscribeMapping("/v2/chat-room/{roomId}/subscribe")
     ...
     * @return
     */
    @MessageMapping("/v2/chat-room/{roomId}/subscribe")
    @SendTo("/topic/v2/chat-room/{roomId}")
     ...
     * @return
     */
    @MessageMapping("/v2/chat-room/{roomId}")
    @SendTo("/topic/v2/chat-room/{roomId}")
     ...
     * @return
     */
    @MessageMapping("/v2/chat-room/{roomId}/leave")
    @SendTo("/topic/v2/chat-room/{roomId}")
